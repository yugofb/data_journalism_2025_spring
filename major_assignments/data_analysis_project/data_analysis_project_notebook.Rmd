...
**Answer: For Prince George's county, day 8 (the last day of early voting) had the highest number of early votes with a total of 6,338. Day 3 had the lowest number of early votes with a total of 1,154. The difference between the highest and lowest days was 5184 votes, with day 8 recieving about 138% more votes than day 3.**
```{r}
...
((6338-1154) / ((6338+1154)/2)) * 100

```


Question #3: Which counties had the highest percentage of rejected mail-in ballots? What was the percentage?
**Answer: **
```{r}
